 ...
 *   prometheus.c 
 *
 *      ./prometheus -s 0 -nprog -f0  -l20   -p60
        ./prometheus -s 3 -nprog -f60 -l1000 -p1
        ./prometheus -s 9 -nprog -f61 -l20   -p60
 *
 *════════════════════════════════════════════════════════════════════════════*/
    ...
    case 0: 
	    ...
	    printf("╔═══════════════════════════════════╗\n");
            printf("║  SE·SO          %02d/%02d/%04d  %02d:%02d ║\n",
                                                    ...
                                                    ptm->tm_min);
            printf("║        ☼☼☼ Prometheus ☼☼☼         ║\n");
            printf("║ Nombre de los programas: %-2s     ║\n", conf.prog_name);
